...
const Empower = () => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 p-6 lg:p-16 bg-gray-50">
      ...
      {/* Image Section */}
      <div className="flex justify-center md:justify-center lg:justify-end sm:order-1 lg:order-2">
        <Image
          src="/empower.png"
          alt="empower"
          width={500}
      ...
      <div className="lg:text-left order-2 lg:order-1 flex flex-col justify-center">
        <h1 className="text-3xl lg:text-5xl font-bold mb-6 text-black">
        ...
        >
          <button
            type="button"
            className="bg-black text-white px-6 py-3 rounded-lg hover:bg-gray-800 transition duration-300 ease-in-out"
          >
            Learn More
          </button>
        </a>
